# 🎓 Student Guide: Week 1 Portfolio Project
...
2. **Wait for your repository to be created** (30 seconds)
   ...
   - It will look like: `github.com/YOUR-CLASS/week1-portfolio-YOUR-NAME`
...
git clone https://github.com/YOUR-CLASS/week1-portfolio-YOUR-NAME.git

# Go into the folder
cd week1-portfolio-YOUR-NAME
...
**💡 Pro Tip:** Keep this terminal running the whole time you're working. Don't close it!
...
2. Find your `week1-portfolio-YOUR-NAME` repository
3. Click "**Import**"
...
1. **GitHub Repository URL**
   - Example: `https://github.com/YOUR-CLASS/week1-portfolio-YOUR-NAME`
...
**Questions?** Ask in class Slack or come to office hours!  
...
**Version:** 1.0  
**For:** Week 1 - Next.js Portfolio Project
